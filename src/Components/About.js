        ...
        return (
            ...
            >
                ...
                <div style={{width:'100%',backgroundColor:'#35d1e6',padding:20}}>
                    <h4 style={{fontWeight:'bold',color:'#040a1e',}}>Full Name        &emsp;&emsp;&emsp;        : Mr. Santosh Penugurthi</h4>
                    <h4 style={{fontWeight:'bold',color:'#040a1e',}}>Email ID         &emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;        : n170425@rguktn.ac.in</h4>
                    <h4 style={{fontWeight:'bold',color:'#040a1e',}}>Mobile Number    &nbsp;        : 8247536054, 9100292646</h4>
